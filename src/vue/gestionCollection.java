 ...
 * </ul> 
 * <p>
 * Un manga peu être ajouteé à la collection
 * </p>
 * <p>
 * Un manga peu être supprimé de la collection
 * </p>
 * <p>
...
// Variables declaration
 ...
 // Variables interface declaration
    ...
    /**
     * Affiche les valeurs de la base de données "manga" dans la table model.
     */
    ...
    /**
     * Récupère la position dans la table tble et joue la methode deplace(i)
    ...
    /**
     * <p>
     * Modifier les valeurs d'un manga dans la base de données
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Supprime les valeurs d'un manga dans la base de données
     * </p>
     * <p>
     * Affiche la table des manga reactualiser
     * </p>
     ...
     * ainsi que toute les valeurs qui sont associées à ce manga
  ...
  //bouton RECHERCHE AUTEUR
    /**
     * Affiche le/les manga qui correspond à l'auteur introduit dans le champ txtRech,
     * ainsi que toute les valeurs qui sont associées à ce/ces manga
